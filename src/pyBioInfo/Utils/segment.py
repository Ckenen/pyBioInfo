...
class SegmentTools(object):
    ...
    #     """
    #     results = []
    #     x1, y1 = 0, 0  # mapped index
    #     x2, y2 = 0, 0  # read index
    #     x3, y3 = segment.reference_start, 0  # reference position
    #     cigartuples = segment.cigartuples
    #     for i in range(len(cigartuples)):
    #         flag, count = cigartuples[i]
    #         if flag == pysam.CMATCH:  # M
    ...
    #             y2 = x2 + count
    #             y3 = x3 + count
    #             results.append(("M", (x1, y1), (x2, y2), (x3, y3)))
    #             x1 = y1
    #             x2 = y2
    #             x3 = y3
    #         elif flag == pysam.CINS:  # I
    #             y2 = x2 + count
    #             results.append(("I", (x1, x1), (x2, y2), (x3, x3)))
    #             x2 = y2
    #         elif flag == pysam.CDEL:  # D
    #             y1 = x1 + count
    #             y3 = x3 + count
    #             results.append(("D", (x1, y1), (x2, x2), (x3, y3)))
    #             x1 = y1
    #             x3 = y3
    #         elif flag == pysam.CREF_SKIP:  # N
    #             y3 = x3 + count
    #             results.append(("N", (x1, x1), (x2, x2), (x3, x3)))
    #             x3 = y3
    #         elif flag == pysam.CSOFT_CLIP:  # S
    #             y2 = x2 + count
    #             results.append(("S", (x1, x1), (x2, y2), (x3, x3)))
    #             x2 = y2
    #         elif flag == pysam.CHARD_CLIP:  # H
    #             results.append(("H", (x1, x1), (x2, x2), (x3, x3)))
    #         elif flag == pysam.CPAD:
    #             raise RuntimeError()
    #         elif flag == pysam.CEQUAL:
    #             raise RuntimeError()
    #         elif flag == pysam.CDIFF:
    #             raise RuntimeError()
    #         elif flag == pysam.CBACK:
    #             raise RuntimeError()
    #         else:
    #             raise RuntimeError()
    #     return results
